...
# количества конфет на 28 минус 1, например 2021 % 28 = 5 - 1 = 4, в этом случае на столе останется
# количество кратное 28 плюс 1, и с каждым следующим ходом первому ходящему необходимо брать такое
# количество, чтобы на столе оставалось кратно 28 плюс 1, тогда первый ходящий игрок победит.
